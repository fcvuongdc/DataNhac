<?php
 ...
 $sql = "INSERT INTO baihatthuvienplaylist (IdThuVienPlayList,IdBaiHat,TenBaiHat,TenCaSi,HinhBaiHat,LinkBaiHat) VALUES 
 ('$idthuvien','$idbaihat' ,'$tenbaihat', '$tencasi', '$hinhbaihat', '$linkbaihat')";
